...
# 6 "2.4-qualifying-data-types.c" 2
# 1 "c:\\mingw\\include\\limits.h" 1 3
# 34 "c:\\mingw\\include\\limits.h" 3
       
# 35 "c:\\mingw\\include\\limits.h" 3
# 7 "2.4-qualifying-data-types.c" 2


# 8 "2.4-qualifying-data-types.c"
int main()
{
    printf("short int... \tsize: %d bytes \t", sizeof(short int));
    printf("%d to %d \n", 
# 11 "2.4-qualifying-data-types.c" 3
                         32767
# 11 "2.4-qualifying-data-types.c"
                                 , 
# 11 "2.4-qualifying-data-types.c" 3
                                   (-32767 -1)
# 11 "2.4-qualifying-data-types.c"
    ...
    printf("%d to %d \n", 
# 14 "2.4-qualifying-data-types.c" 3
                         2147483647L
# 14 "2.4-qualifying-data-types.c"
                                 , 
# 14 "2.4-qualifying-data-types.c" 3
                                   (-2147483647L -1)
# 14 "2.4-qualifying-data-types.c"
